...
const CompanyAdminEmployeeDetailCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`https://localhost:7136/api/Company/AdminEmployeeDetailCreate/${employeeId}`, preparedData, {
                headers: {
...
export default CompanyAdminEmployeeDetailCreate;