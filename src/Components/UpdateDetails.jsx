...
const UpdateDetails = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const preparedData = {
            ...formData,
            birthDate: formData.birthDate || null, // Prepare birthDate
        ...
        try {
            const response = await axios.put(`https://localhost:7136/api/Employee/UpdateEmployeeDetail/${employeeId}`, preparedData, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
